...
#   subnet_ids  = var.subnet_ids # 프라이빗 서브넷의 ID를 모두 포함
...
#   name        = "${var.prefix}-dev-test-param-group"
...
#   vpc_security_group_ids = var.vpc_security_group_ids                 # 관련된 보안 그룹 참조
...
#   parameter_group_name   = aws_db_parameter_group.db_param_group.name # 파라미터 그룹 참조
